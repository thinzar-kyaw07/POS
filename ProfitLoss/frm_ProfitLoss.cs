...
namespace POS.ProfitLoss
{
    public partial class frm_ProfitLoss : Form
    {
        ...
        {
            if (dgvProfitLoss.Rows.Count > 1)
            {
                frm_Report frmReport = new frm_Report();
                crpt_ProfitLoss crpt = new crpt_ProfitLoss();
        ...
        private void ShowData()
        {
            ...
            SPString = string.Format("SP_Select_ProfitLoss N'{0}',N'{1}',N'{2}',N'{3}'",
            dtpStartDate.Value.ToShortDateString(), dtpEndDate.Value.ToShortDateString(), "0", "2");
            ...
            SPString = String.Format("SP_Select_ProfitLoss N'{0}',N'{1}',N'{2}',N'{3}'", txtItemName.Text,
               dtpStartDate.Value.ToShortDateString(), dtpEndDate.Value.ToShortDateString(), "0");
            DTPurchase = obj_clsMainDB.SelectData(SPString);

            SPString = String.Format("SP_Select_ProfitLoss N'{0}',N'{1}',N'{2}',N'{3}'", txtItemName.Text,
               dtpStartDate.Value.ToShortDateString(), dtpEndDate.Value.ToShortDateString(), "1");

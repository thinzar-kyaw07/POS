...
namespace POS.MasterData
{
    public partial class frm_Purchase : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            else if (Convert.ToInt32(txtQty.Text.Trim().ToString()) <= 0 ||
            Convert.ToInt32(txtQty.Text.Trim().ToString()) > 10000)
            {
            ...
            else if (Convert.ToInt32(txtPrice.Text.Trim().ToString()) < 1000 ||
                              Convert.ToInt32(txtPrice.Text.Trim().ToString()) > 10000000)
            {
        ...
        private void btnRemove_Click(object sender, EventArgs e)
        {
            ...
            {
                DataRow[] Arr_DR = DTPurchase.Select("ItemID='" + dgvPurchase.CurrentRow.Cells["ItemID"].
                Value.ToString() + "'");
                DataRow DR = Arr_DR[0];
                DR.Delete();
                dgvPurchase.DataSource = DTPurchase;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < DTPurchase.Rows.Count; i++)
                {
                    ...
                    obj_clsPurchaseDetail.ITEMID = int.Parse(DTPurchase.Rows[i]["ItemID"].ToString());

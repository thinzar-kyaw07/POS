...
namespace POS.Sale
{
    public partial class frm_SaleList : Form
    {
        ...
        clsSaleDetail obj_SaleDetail = new clsSaleDetail();
        ...
        private void tsbNew_Click(object sender, EventArgs e)
        {
            ...
            frm.ShowDialog();
            SPString = string.Format("EXEC SP_Select_Sale N'{0}',N'{1}',N'{2}'", "0", "0", "0");
            dgvSale.DataSource = obj_clsMainDB.SelectData(SPString);
        }
        ...
        private void tstSearchWith_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                SPString = string.Format("EXEC SP_Select_Sale N'{0}',N'{1}',N'{2}'", tstSearchWith.Text.Trim().ToString(),
                "0", "4");
            }
        ...
        private void tsbPrint_Click(object sender, EventArgs e)
        {
            if (dgvSale.Rows.Count > 0)
            {
                ...
                if (tslLabel.Text == "SaleDate")
                {
                    SPString = string.Format("EXEC SP_Select_SaleReport N'{0}',N'{1}',N'{2}'",
                    tstSearchWith.Text.Trim().ToString(), "0", "1");
                }
                else if (tslLabel.Text == "UserName")
                {
                    SPString = string.Format("EXEC SP_Select_SaleReport N'{0}',N'{1}',N'{2}'",

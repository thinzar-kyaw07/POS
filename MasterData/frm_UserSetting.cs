...
namespace POS.MasterData
{
    public partial class frm_UserSetting : Form
    {
        ...
        frm_Main obj_frmMain = new frm_Main();
        ...
        public void ShowUserLevel()
        {
            ...
            for (int i = 0; i < obj_frmMain.menuStrip1.Items.Count; i++)
            {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                SPString = String.Format("SP_Select_UserSetting N'{0}',N'{1}',N'{2}'", txtName.Text.Trim().ToString(), txtPassword.Text.Trim().ToString(), "1");
                ...
                else
                {
                    ...
                    obj_clsUserSetting.UNAME = txtName.Text.Trim().ToString();
                    ...
                    if(_isEdit)
                    {
                        ...
                        MessageBox.Show("Succesfully Edited", "Successfully", MessageBoxButtons.OK);
                        this.Close();
                    }
                    else
                    {

...
namespace POS.MasterData
{
    public partial class frm_Item : Form
    {
        ...
        public bool _IsEdit = false; //insert, update
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else if (Convert.ToInt32(txtPrice.Text) != 0 && (Convert.ToInt32(txtPrice.Text) < 1000 ||
         Convert.ToInt32(txtPrice.Text) > 1000000))
            {
            ...
            {
                SPString = string.Format("SP_Select_Item N'{0}',N'{1}',N'{2}'", txtItemName.Text.Trim().ToString(),
            "0", "1");
                ...
                else
                {
                    ...
                    obj_clsItem.UPDATEDATE = lblUpdateDate.Text;
                    if (_IsEdit)
                    {
